...
//Function to sort hotels by pricing low to high
function sortHotelsByPriceLowtoHigh(hotel1, hotel2) {
  return hotel1.price - hotel2.price;
}

//Function to sort hotels by pricing high to low
...
app.get('/hotels/sort/pricing', (req, res) => {
  ...
  if (pricing === 'low-to-high') {
    sortedHotels.sort(sortHotelsByPriceLowtoHigh);
  } else {
    sortedHotels.sort(sortHotelsByPriceHightoLow);
  }

  res.json({ hotels: sortedHotels });
});

//Function to sort hotels by rating low to high
function sortHotelsByRatingLowtoHigh(hotel1, hotel2) {
  return hotel1.rating - hotel2.rating;
}

//Function to sort hotels by rating high to low
...
app.get('/hotels/sort/rating', (req, res) => {
  ...
  if (rating === 'low-to-high') {
    sortedHotels.sort(sortHotelsByRatingLowtoHigh);
  } else {
    sortedHotels.sort(sortHotelsByRatingHightoLow);
  }

  res.json({ hotels: sortedHotels });
});

//Function to sort hotels by reviews low to high
function sortHotelsByReviewsLeasttoMost(hotel1, hotel2) {
  return hotel1.reviews - hotel2.reviews;
}

//Function to sort hotels by reviews high to low
...
app.get('/hotels/sort/reviews', (req, res) => {
  ...
  if (reviews === 'least-to-most') {
    sortedHotels.sort(sortHotelsByReviewsLeasttoMost);
  } else {
    sortedHotels.sort(sortHotelsByReviewsMosttoLeast);
  }

  res.json({ hotels: sortedHotels });
});

//Function to filter hotels based on amenity
...
//Function to filter hotels based on country
...
//Function to filter the hotels based on category
